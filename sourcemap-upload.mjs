...
const cmd = `npx datadog-ci sourcemaps upload ${sourcemappath} --service ${service} --minified-path-prefix ${minifiedpath} --release-version ${version} --disable-git --max-concurrency 100 --project-path=./src/  `;
console.log(cmd);
